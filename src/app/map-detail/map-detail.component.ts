...
@Component({
  selector: 'cm-map-detail',
  templateUrl: './map-detail.component.html',
  styleUrls: ['./map-detail.component.css']
})
export class MapDetailComponent implements DoCheck, OnInit {
  ...
  ngOnInit() {
    this.userService.getMap(this.route.snapshot.paramMap.get("id")).subscribe (res => {
      console.log(res);
    }, error => {
      console.log(error);
    });
